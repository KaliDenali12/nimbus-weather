...
const themes: Record<ThemeKey, WeatherTheme> = {
  'clear-day': {
    ...
    cardSurface: 'rgba(15, 25, 50, 0.65)',
  ...
  'clear-night': {
    ...
    cardSurface: 'rgba(10, 15, 35, 0.70)',
  ...
  'foggy-day': {
    ...
    cardSurface: 'rgba(15, 25, 50, 0.60)',
    cardBorder: 'rgba(255, 255, 255, 0.15)',
    textPrimary: '#ffffff',
    textSecondary: 'rgba(255, 255, 255, 0.88)',
  },
  ...
  'drizzle-day': {
    ...
    cardBorder: 'rgba(255, 255, 255, 0.15)',
    textPrimary: '#f0f4f8',
    textSecondary: 'rgba(240, 244, 248, 0.88)',
  },
  'drizzle-night': {
    ...
    textPrimary: '#c8d6e0',
    textSecondary: 'rgba(200, 214, 224, 0.85)',
  },
  'rain-day': {
    bgGradient: 'linear-gradient(135deg, #1c3550 0%, #2a4d6b 50%, #3f6d8c 100%)',
    cardSurface: 'rgba(10, 20, 40, 0.70)',
    cardBorder: 'rgba(255, 255, 255, 0.12)',
    textPrimary: '#e2e8f0',
    textSecondary: 'rgba(226, 232, 240, 0.85)',
  },
  ...
  'snow-day': {
    ...
    cardSurface: 'rgba(255, 255, 255, 0.70)',
    cardBorder: 'rgba(0, 0, 0, 0.08)',
    textPrimary: '#1a2533',
    textSecondary: 'rgba(26, 37, 51, 0.82)',
  },
  'snow-night': {
  ...
  'storm-day': {
    ...
    cardSurface: 'rgba(10, 10, 25, 0.75)',
    cardBorder: 'rgba(255, 255, 255, 0.10)',
    textPrimary: '#d4d4e0',
    textSecondary: 'rgba(212, 212, 224, 0.85)',
  },
  'storm-night': {
    bgGradient: 'linear-gradient(135deg, #12121f 0%, #22223a 50%, #323252 100%)',
    cardSurface: 'rgba(10, 10, 25, 0.75)',
...
const darkModeTheme: WeatherTheme = {
  ...
  cardSurface: 'rgba(30, 30, 35, 0.85)',
  cardBorder: 'rgba(255, 255, 255, 0.10)',
  textPrimary: '#e4e4e7',
  textSecondary: 'rgba(228, 228, 231, 0.80)',
}
